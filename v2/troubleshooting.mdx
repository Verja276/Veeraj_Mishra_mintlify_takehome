...
<Columns cols={3}>
  ...
  <Card title="Account Locked" href="#login-issues">
...
4. **Setup Problems**: Follow our [2FA setup guide](#two-factor-auth)
...
<Columns cols={3}>
  ...
  <Card title="Network Issues" href="#slow-loading-times">
    Check internet speed, try different network.
  </Card>

  <Card title="Data Issues" href="#slow-loading-times">
