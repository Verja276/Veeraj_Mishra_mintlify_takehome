...
<Columns cols={2}>
  <Card title="Start with v2.0" href="/v2/getting-started">
    New to Salsa as a Service? Start with v2.0 today.
  </Card>

  <Card title="Upgrade from v1.0" href="https://app.salsaasaservice.com/upgrade">
    Existing customer? Upgrade to v2.0 in minutes.
  </Card>

  <Card title="Explore Advanced Features" href="/v2/advanced-usage">
    Learn about AI forecasting, IoT integration, and more.
  </Card>

  <Card title="View Integrations" href="/v2/integrations">
