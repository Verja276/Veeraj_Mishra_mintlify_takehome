...
<Columns cols={3}>
  ...
  <Card title="Freshness Sensors">
    RFID and chemical sensors track ingredient freshness.
  </Card>

  <Card title="Quality Meters">
...
<Columns cols={3}>
  ...
  <Card title="AR Sensor Placement">
...
<Columns cols={3}>
  ...
  <Card title="Integrations Guide" href="/v2/integrations">
    Explore all 50+ available integrations.
  </Card>

  <Card title="API Documentation" href="/v2/api-reference">
